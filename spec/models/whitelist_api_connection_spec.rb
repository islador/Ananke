...
describe WhitelistApiConnection do
	...
	let!(:whitelist_entity) {FactoryGirl.create(:whitelist, source_type: 1, source_share_user: share_user.id)}
	...
	let!(:whitelist_entity2) {FactoryGirl.create(:whitelist, source_type: 1, source_share_user: share_user.id)}
	let!(:whitelist_api_connection_api2_whitelist_entity2) {FactoryGirl.create(:whitelist_api_connection, api_id: api2.id, whitelist_id: whitelist_entity2.id)}
	let!(:whitelist_api_connection_api_whitelist_entity2) {FactoryGirl.create(:whitelist_api_connection, api_id: api.id, whitelist_id: whitelist_entity2.id)}
